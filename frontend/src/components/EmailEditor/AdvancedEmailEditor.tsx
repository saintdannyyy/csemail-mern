      ...
      .map((block) => {
        switch (block.type) {
          ...
          case "button":
            ...
            }; color: ${block.styles.color}; padding: ${
          ...
          case "columns":
            ...
            ${block.content.columns
              .map((col: any) => `<div style="flex: 1;">${col.content}</div>`)
              .join("")}
          </div>`;
          case "social":
            return `<div style="${styleObjectToString(block.styles)}">
              ...
              <div className="max-w-2xl mx-auto bg-white border border-gray-200 rounded-lg shadow-sm">
                {blocks.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p>
                      Start building your email by adding blocks from the left
                      panel
                    </p>
                  </div>
                ) : (
                      ...
                      >
                        ...
                        <div
                          dangerouslySetInnerHTML={{
                            __html:
                              generateHTML().split("</div>")[index] + "</div>",
                          }}
                        />
                      </div>
                    ))}
